public class AES {
     ...
     * Used in SubBytes transformation during encryption
     ...
     * Used in InvSubBytes transformation during decryption
     * This is the inverse lookup table of SBOX
     */
    ...
    public static void main(String[] args) {
        ...
        byte[] paddedPlainText = addPKCS7Padding(plainText.getBytes());
        String cipherText = "Hello";
        System.out.println("Plain Text: " + args[0] + ",  Cipher Text: " + cipherText + "\n");
    }
    ...
    public static byte[] removePKCS7Padding(byte[] data) {
        ...
        System.arraycopy(data, 0, unpaddedData, 0, data.length - padding);
        return unpaddedData;
    }

    public static void addRoundKey(byte[] state, byte[] roundKey) {
        if (state.length != 16 || roundKey.length != 16) {
            throw new IllegalArgumentException("State and roundKey must be 16 bytes");
        }
